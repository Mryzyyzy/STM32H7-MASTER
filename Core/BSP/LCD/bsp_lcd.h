/**
 * ===========================================================================
 * BSP 驱动层 — 1.69寸LCD (SPI1, 240x280, ST7789兼容)
 * ===========================================================================
 *
 * 引脚映射：
 *   PD7=SPI1_MOSI  PB3=SPI1_SCK  PB4=SPI1_MISO
 *   PA15=CS  PC13=RST  PC4=DC(指令/数据)  PA7=背光
 *
 * 时钟：SPI1/SPI2 共用 PLL2=150MHz（24MHz/16*100/1），SPI1 SCK=75MHz，SPI2 SCK≈1.17MHz。
 */
#ifndef __BSP_LCD_H
#define __BSP_LCD_H
...
// 显示方向参数
// 使用示例：LCD_SetDirection(Direction_H) 设置屏幕横屏显示
...
颜色值为24位色（RGB888），内部转换为16位 RGB565
...
extern SPI_HandleTypeDef hspi1;       // SPI1 句柄
...
// 低电平，关闭背光
#define LCD_Bkglight_OFF    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_7, GPIO_PIN_RESET)
// 高电平，开启背光
#define LCD_Bkglight_ON     HAL_GPIO_WritePin(GPIOA, GPIO_PIN_7, GPIO_PIN_SET)
