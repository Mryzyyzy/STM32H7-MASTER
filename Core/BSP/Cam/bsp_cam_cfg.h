/**
 * ===========================================================================
 * BSP 驱动层 — OV5640 初始化配置表
 * ===========================================================================
 *
 * 默认配置：4:3(1280*960) ISP窗口，约43帧，JPG模式2/3下帧率减半。
 * 时钟：XVCLK=24MHz, PLL预分频=3, 倍频=80, 系统分频=2.5, PCLK手动分频。
 * 参考：OV5640 应用手册及寄存器手册 4.2 节 image windowing。
 */
#pragma once
